@include('partials.header', ['title' => 'Registration'])
	<header class="max-w-lg mx-auto">
		<a href="#">
			<h1 class="text-4xl font-bold text-white text-center">Admin Registration</h1>
		</a>
	</header>
	<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
		<section>
			<h3 class="font-bold text-2xl">Welcome to User Manager!!</h3>
		...
		<section class="mt-10">
			<form action="/store" method="POST" class="flex flex-col">
				...
				<div class="mb-6 pt-3 rounded bg-gray-200">
					...
					<input type="text" name="user_name" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3">
				</div>
				...
				<div class="mb-6 pt-3 rounded bg-gray-200">
					...
					<input type="text" name="middle_name" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3">
				</div>
